...
except ImportError: # name doesn't exist yet
...
def main() -> None:
    ...
    logging.info("missing created_at after parse: %s / %s", n_missing_ts, len(orders_t))
    ...
    logging.info("rows=%s | country match rate=%.3f", len(joined), match_rate)
